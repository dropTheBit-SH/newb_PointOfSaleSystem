...
public class View extends MyFrame{
	...
	public View() {
		...
		btnMenu_Option = new JButton("OPTION");
		btnMenu_Option.setFont(new Font("Arial Black", Font.PLAIN, 15));
		panMenu_6.add(btnMenu_Option, BorderLayout.CENTER);
		...
		btnMenu_Option.setBackground(mycolor6);
		...
		btnMenu_Option.setForeground(mycolor1);
