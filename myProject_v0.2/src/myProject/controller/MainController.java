...
public class MainController extends Controller implements ActionListener, MouseListener{
	...
	public MainController() {
		...
		mainView.btnMenu_Admin.addActionListener(this);
		...
		mainView.btnPay.addActionListener(this);
		mainView.btnReceipt.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() instanceof JButton) {
			...
			if(btn == mainView.btnMenu_Main) {
				...
				mainView.setVisible(false);
				new SalesController();
			}else if (btn == mainView.btnMenu_Admin) {
				mainView.setVisible(false);
				new AdminController();
			...
			if(btn == mainView.btnPay) {
				new ReceiptController();
			}else if (btn == mainView.btnReceipt) {
				System.out.println("영수증 출력 띠리릭");
			}
		}
	}
