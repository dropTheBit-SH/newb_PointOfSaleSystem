...
public class MainView extends View {
	...
	public MainView() {
		...
		btnPay = new JButton(new ImageIcon("src/myProject/image/1002.jpg"));
		btnPay.setBackground(mycolor3);
		panel_4.add(btnPay);

		btnReceipt = new JButton(new ImageIcon("src/myProject/image/1004.jpg"));
		btnReceipt.setBackground(mycolor3);
